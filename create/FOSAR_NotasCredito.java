// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 07/11/2011 05:15:15 p.m.
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   FOSAR_NotasCredito.java
...
public class FOSAR_NotasCredito
{
        ...
        throws SQLException, ComprobanteArchRefException, ClassNotFoundException, IOException
    {
        ...
        if(FOLIO != folioaspel)
        {
            ...
            FOSAR_NotasCredito _tmp1 = this;
            ClienteChat.Envia_Mensaje(msj, 3);
        } else
        {
            if(ExisteDocumento())
            {
        ...
        throws SQLException
    {
        ...
        String sqlrfc = (new StringBuilder()).append("SELECT CVE_DOC FROM CANCELADAS_FOSAR WHERE CVE_DOC = '").append(cvedoc).append("' AND SERIE = 'MD'").toString();
        rs = cnx.consulta(sqlrfc, true);
        if(rs.next())
            existe = true;
        return existe;
        ...
        throws SQLException
    {
        ...
        String sqlry = (new StringBuilder()).append("INSERT INTO CANCELADAS_FOSAR (NUM_REG, FOLIO, SERIE, ESTADO, CVE_DOC) VALUES( ").append(NUM_REG).append(",").append(FOLIO).append(",'").append(SERIE).append("','A','").append(CVE_DOC).append("')").toString();
