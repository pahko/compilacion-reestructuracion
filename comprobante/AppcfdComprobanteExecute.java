...
public class AppcfdComprobanteExecute
{
    ...
    public AppcfdComprobanteExecute()
    {
    }

    public static void main(String arg[])
        throws ComprobanteArchRefException, IOException, SQLException, CFDException, JDOMException, NumberFormatException, ClassNotFoundException
    {
        apc.conected();
        try
        {
