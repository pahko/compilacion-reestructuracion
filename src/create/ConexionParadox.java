...
public class ConexionParadox {
    ...
    public void conectarParadox() throws ClassNotFoundException, SQLException, IOException {
    ...
    public static void conectarSunODBC(String path) throws ClassNotFoundException, SQLException, IOException {
        try {
