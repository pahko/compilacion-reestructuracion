...
public class FOSAR_ACT_ARTICULOS {
    String sql;
    ...
    FOSAR_ACT_ARTICULOS() throws SQLException, ComprobanteArchRefException,
    ...
    void Recupera_Ult_Registro_FDB() throws SQLException {
        String sqlrfc = "SELECT MAX(NUM_REG) FROM FOSAR_ARTICULOS ";
    ...
    void Recupera_Arts_Paradox() throws SQLException {
        String clv_art = "";
        String sqlry = (new StringBuilder()).append("SELECT NUM_REG, CLV_ART FROM INVE01  WHERE NUM_REG > ").append(MAX_NUM_REG).toString();
    ...
    void Inserta_Arts_FDEB() throws SQLException {
    ...
    void Inserta_Art_FDB(String num_reg, String clv_art) throws SQLException {
        String sqlr = (new StringBuilder()).append("INSERT INTO FOSAR_ARTICULOS (NUM_REG, CLV_ART) VALUES( ").append(num_reg).append(",'").append(clv_art).append("')").toString();
